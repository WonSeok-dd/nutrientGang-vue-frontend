...
export default {
    ...
    computed : {
        TargetModel : {
            get(){
                return this.$store.state.modifyInfoTarget
            },
            set(val){
                this.$store.state.modifyInfoTarget = val
            }
        },
        ActivityModel : {
            get(){
                return this.$store.state.modifyInfoActivity
            },
            set(val){
                this.$store.state.modifyInfoActivity = val
            }
        },
    },
}
